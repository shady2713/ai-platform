...
public class JobController {
    ...
    public CommonResult<Boolean> updateJobStatus(
            @RequestParam(value = "id") @Positive Long id, @RequestParam("status") Integer status)
    ...
    public void export(HttpServletResponse response, @Valid JobPageReqVO exportReqVO) throws IOException {
