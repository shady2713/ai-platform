...
INSERT INTO `system_dept` VALUES (100,'总公司',0,0,1,NULL,NULL,0,'admin','2021-01-05 17:03:47','1','2026-08-23 14:13:52',_binary '\0');
...
CREATE TABLE `system_user_session` (
  ...
  `refresh_family_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL COMMENT '刷新会话稳定撤销凭据 SHA-256 摘要',
  ...
  UNIQUE KEY `uk_user_session_refresh_family_hash` (`refresh_family_hash`),
...
CREATE TABLE `system_users` (
  ...
  `must_change_password` bit(1) NOT NULL DEFAULT b'0' COMMENT '下次登录前必须修改密码',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  UNIQUE KEY `uk_system_users_mobile_active` ((CASE WHEN `deleted` = b'0' THEN NULLIF(TRIM(`mobile`), '') ELSE NULL END)),
  UNIQUE KEY `uk_system_users_email_active` ((CASE WHEN `deleted` = b'0' THEN NULLIF(TRIM(`email`), '') ELSE NULL END)),
  KEY `idx_mobile` (`mobile`),
  KEY `idx_email` (`email`),
...
--
-- 种子管理员密码为不可登录的封存标记，must_change_password 置 1。
-- 种子账号默认禁用；通过部署独立口令激活，见 docs/deployment.md。

LOCK TABLES `system_users` WRITE;
/*!40000 ALTER TABLE `system_users` DISABLE KEYS */;
INSERT INTO `system_users` VALUES (1,'admin','!bootstrap-required','总部门','管理员',100,'[]',NULL,NULL,2,'',1,'',NULL,b'1','admin','2021-01-05 17:03:47',NULL,'2026-08-23 14:13:52',_binary '\0');
...
CREATE TABLE `ai_run` (
  ...
  `run_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '运行业务键（run_ 前缀，主体内唯一）',
  `application_id` bigint NOT NULL COMMENT '应用编号',
  `subject_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主体类型（APP/USER）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI 运行（受理即固定发布版本，O02）';

DROP TABLE IF EXISTS `ai_run_idempotency`;

CREATE TABLE `ai_run_idempotency` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '幂等记录编号',
  `application_id` bigint NOT NULL COMMENT '应用编号',
  `subject_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主体类型',
  `external_user_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '可信外部用户标识',
  `idempotency_key` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '幂等键（调用方提供，主体内唯一）',
  `request_digest` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '请求摘要（与 run.input_digest 一致才算同一请求）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI 运行幂等记录（唯一键兜底并发，O02）';

DROP TABLE IF EXISTS `ai_run_task`;

CREATE TABLE `ai_run_task` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '任务编号',
  `run_id` bigint NOT NULL COMMENT '运行编号',
  `task_kind` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '任务类型（首任务为 RUN_STEP）',
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '状态（QUEUED/RUNNING/SUCCEEDED/FAILED/UNKNOWN）',
...
CREATE TABLE `ai_tool` (
  ...
  `code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工具标识（全局唯一且创建后不可修改）',
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '工具名称',
  `description` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '说明（供模型理解用途）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI 工具注册（版本化执行政策的载体，D08）';

DROP TABLE IF EXISTS `ai_tool_version`;
...
CREATE TABLE `ai_tool_version` (
  ...
  `status` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DRAFT' COMMENT '状态（DRAFT/PUBLISHED）',
  `tool_type` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'READ' COMMENT '类型（READ/WRITE）；首期只允许发布 READ',
  `policy` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DENY' COMMENT '执行政策（AUTO/CONFIRM/DENY），默认 DENY',
  `source_kind` varchar(24) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源类型（HTTP_OPERATION）',
  `source_ref` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源标识（operationKey）',
  `input_schema_json` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '输入 schema（声明参数名/类型/必填）',
  `output_schema_json` varchar(4000) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '输出 schema（结果列声明）',
  `schema_hash` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '版本内容哈希（政策+schema+来源）',
  `published_at` datetime DEFAULT NULL COMMENT '发布时间',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  ...
  `deleted` bit(1) NOT NULL DEFAULT b'0' COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_ai_tool_version_no` ((if(`deleted` = b'1',NULL,concat(`tool_id`,_utf8mb4':',`version_no`)))),
...
CREATE TABLE `ai_knowledge_base` (
    ...
    `code`                 varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL COMMENT '知识库标识（全局唯一且创建后不可修改）',
    `name`                 varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '知识库名称',
    `description`          varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '说明',
    `visibility`           varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL DEFAULT 'APPLICATION' COMMENT '可见性（SHARED 共享/APPLICATION 应用专用）',
    ...
    `embedding_model`      varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL COMMENT '嵌入模型标识（K05 按它解析模型端点）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI 知识库（共享/应用专用 + 嵌入模型与维度，K02）';

--
-- AI 知识文档（sourceKey 幂等 + active 版本指针，K02）
--
...
CREATE TABLE `ai_knowledge_document` (
    ...
    `source_key`        varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '来源幂等键（库内唯一；外部同步键或上传文件名）',
    `title`             varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '文档标题',
    `source_type`       varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL DEFAULT 'UPLOAD' COMMENT '来源类型（UPLOAD 上传/API_SYNC 受授权同步）',
    `source_ref`        varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源位置（同步来源的受控标识，不抓取第三方站点）',
    `status`            varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL DEFAULT 'PENDING' COMMENT '状态（PENDING/PARSING/INDEXING/READY/FAILED/DELETING）',
    `active_version_no` int          NOT NULL DEFAULT '0' COMMENT '当前可用版本号（0 表示尚无可用版本；索引成功后才切换）',
    `latest_version_no` int          NOT NULL DEFAULT '0' COMMENT '最新版本号（0 表示尚无版本）',
    `failure_reason`    varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '最近失败原因（脱敏稳定原因码，不含正文）',
    `parse_note`        varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '解析提示（例如扫描件需要 OCR，K04 写入）',
    `version`           int          NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
    `creator`           varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '创建者',
    `create_time`       datetime     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updater`           varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '更新者',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI 知识文档（sourceKey 幂等 + active 版本指针，K02）';

--
-- AI 知识文档版本（私有文件绑定 + 发布后不可变，K02）
--

DROP TABLE IF EXISTS `ai_knowledge_document_version`;
...
CREATE TABLE `ai_knowledge_document_version` (
    ...
    `content_hash`      char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci     NOT NULL COMMENT '文件指纹（sha256 hex；同指纹重复入库不产生新版本）',
    `source_ref`        varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源位置（片段引用可追溯到该版本的来源）',
    `status`            varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL DEFAULT 'INDEXING' COMMENT '状态（INDEXING/READY/FAILED/SUPERSEDED）',
    `index_generation`  int          DEFAULT NULL COMMENT '切片所属索引代（READY 时必填）',
    `chunk_count`       int          NOT NULL DEFAULT '0' COMMENT '切片数（索引成功后写入）',
    `failure_reason`    varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '失败原因（脱敏稳定原因码）',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI 知识文档版本（私有文件绑定 + 发布后不可变，K02）';

--
-- AI 知识切片（派生数据，物理清理，K02）
--
...
CREATE TABLE `ai_knowledge_chunk` (
    ...
    `content_hash`        char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci     NOT NULL COMMENT '切片正文哈希（幂等与去重；正文存向量服务载荷）',
    `text_length`         int          NOT NULL COMMENT '正文长度（字符数，用于上下文预算）',
    `token_count`         int          NOT NULL DEFAULT '0' COMMENT '估算 token 数（预算与截断）',
    `vector_id`           varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL COMMENT '向量点标识（确定性 UUID，K01 映射）',
    `index_generation`    int          NOT NULL COMMENT '所属索引代',
    `location_ref`        varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '来源位置（页码/章节等，引用可核验）',
    `creator`             varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '创建者',
    `create_time`         datetime     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `updater`             varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '更新者',
    `update_time`         datetime     NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='AI 知识切片（派生数据，物理清理，K02）';

--
-- AI 知识索引代（版本化索引，K02）
--

DROP TABLE IF EXISTS `ai_knowledge_index_generation`;
...
CREATE TABLE `ai_knowledge_index_generation` (
    ...
    `embedding_model`   varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL COMMENT '嵌入模型标识（换模型必须换代，禁止混用向量，AT-029）',
    `dimension`         int          NOT NULL COMMENT '向量维度（必须与知识库声明一致）',
    `collection_name`   varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '向量集合名（物理索引名）',
    `status`            varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci  NOT NULL DEFAULT 'BUILDING' COMMENT '状态（BUILDING/ACTIVE/RETIRED/FAILED）',
...
-- AI 知识库菜单与权限点（V72）
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES
(4090, 'AI 知识库', 'ai:knowledge:query', 2, 10, 4000, 'knowledge', 'ep:notebook',
...
-- 工具菜单与权限点（V70）
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES
(4080, 'AI 工具', 'ai:tool:query', 2, 9, 4000, 'tool', 'ep:tools', 'ai/tool/index', 'AiTool', 0, b'1', b'1', b'1', '1', '2026-09-21 10:00:00', '1', '2026-09-21 10:00:00', b'0'),
(4081, '工具新增', 'ai:tool:create', 3, 1, 4080, '', '', '', NULL, 0, b'1', b'1', b'1', '1', '2026-09-21 10:00:00', '1', '2026-09-21 10:00:00', b'0'),
...
CREATE TABLE `ai_eval_suite` (
  ...
  `content_digest` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '冻结内容摘要（套件 + 样例规范化后的 SHA-256）',
  `version` int NOT NULL DEFAULT '0' COMMENT '乐观锁版本',
  `creator` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '创建者',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updater` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '' COMMENT '更新者',
...
-- 用量监控、运行监控与评测菜单、权限点（V81/V82/V83）
INSERT INTO `system_menu` (`id`, `name`, `permission`, `type`, `sort`, `parent_id`, `path`, `icon`, `component`, `component_name`, `status`, `visible`, `keep_alive`, `always_show`, `creator`, `create_time`, `updater`, `update_time`, `deleted`) VALUES
...
(4120, '评测套件', 'ai:eval:query', 2, 16, 4000, 'evaluation', 'ep:data-analysis', 'ai/evaluation/index', 'AiEvaluation', 0, b'1', b'1', b'1', '1', '2026-09-26 19:00:00', '1', '2026-09-26 19:00:00', b'0'),
